...
function getDataQueryString($dataset, $db, $gff_table, $accession_mapping_table, $gene, $chromosome, $where = "")
{
    if (
        ...
        // Generate SQL string
        $query_str = "SELECT ACD.Race, ACD.Origin, ";
        $query_str = $query_str . "ACD.Location, ";
        $query_str = $query_str . "ACD.Accession, ACD.Name, ACD.Sample_Name, ";
        ...
        $query_str = $query_str . "	SELECT AM.Race, AM.Origin, ";
        $query_str = $query_str . "	AM.Location, ";
        $query_str = $query_str . "	GENO.Accession, AM.Name, AM.Sample_Name, ";
        ...
        $query_str = $query_str . "	GROUP BY AM.Race, AM.Origin, AM.Location, GENO.Accession, AM.Name, AM.Sample_Name, COMB1.Gene, GENO.Chromosome ";
        $query_str = $query_str . ") AS ACD ";
        $query_str = $query_str . $where . " ";
        $query_str = $query_str . "ORDER BY ACD.Gene, ACD.Origin; ";
    } else {
        // Generate SQL string
