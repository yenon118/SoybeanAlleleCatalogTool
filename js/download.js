...
function createAndDownloadCsvFile(csvString, filename) {
    let dataStr = "data:text/csv;charset=utf-8," + csvString;
...
function downloadAllByAccessionsAndGene(dataset, accessions, gene) {
    filename = dataset + "__" + accessions.replace(/[^a-zA-Z0-9]/g, '_') + "__" + gene + "__data";

    accessions = accessions.split(";");

    $.ajax({
        url: 'php/downloadAllByAccessionsAndGene.php',
        type: 'GET',
        contentType: 'application/json',
        data: {
            Gene: gene,
